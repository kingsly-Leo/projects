import pandas as pd
airline_df = pd.read_csv("C:\\Users\\Hp\\OneDrive\\Desktop\\Machine Learning Project [24-PDS-013]\\data_airline_reviews.csv")
...
log_class = LogisticRegression(max_iter=2000, solver='saga')  
